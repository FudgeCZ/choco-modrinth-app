...
const messages = defineMessages({
	...
	noServersDescription: {
		...
		defaultMessage: 'Install mods, invite friends, and play together all from the ChocoModrinth.',
	},
	...
	playWithFriendsDescription: {
		...
		defaultMessage: 'Invite friends to play your server with one-click play from the ChocoModrinth.',
	},
	newServerButton: {
