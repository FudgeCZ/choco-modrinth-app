...
const messages = defineMessages({
	openingApp: {
		...
		defaultMessage: 'Opening ChocoModrinth',
	},
	whyUseApp: {
		id: 'modal.open-in-app.why-use',
		defaultMessage: 'Why use the ChocoModrinth',
	},
	benefitLaunch: {
	...
	openingAutomatically: {
		...
		defaultMessage: 'The ChocoModrinth will open automatically...',
	},
	getApp: {
		id: 'modal.open-in-app.get-app',
		defaultMessage: 'Get ChocoModrinth',
	},
})
